...
public class GitHubAccount {
    private int num, followers, repoNo, following;
    private String login, url, profileURL;
    ...
    GitHubAccount(int column1, int column2, int column3, String column4, String column5){
        this.followers = column1;
        this.repoNo = column2;
        this.following = column3;
        this.profileURL = column4;
        this.url = column5;
    ...
    public void setProfileURL(String column3) {
        this.profileURL = column3;
    }
}
