...
public class exportToExcel {
    private static final String[] columns = {"No.", "Login ID", "No. of Repositories", "No. of Followers", "Following Count", "Github Link"};
    ...
    public void exportExcel(ArrayList<GitHubAccount> follower) throws IOException, InterruptedException {
        ...
        for (GitHubAccount followerTable : follower) {
            ...
            column6.setCellValue(followerTable.getProfileURL());
